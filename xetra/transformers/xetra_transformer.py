...
class XetraETL():
    ...
    def __init__(self, s3_bucket_src: S3BucketConnector,
        ...
        :param meta_key: used as self.meta_key -> key for meta file
    ...
    def extract(self) -> pd.DataFrame:
        ...
        :return:
            data_frame: Pandas DataFrame with extracted data
        """
    ...
    def transform_report1(self, data_frame: pd.DataFrame):
        ...
        data_frame[self.trg_args.trg_col_ch_prev_clos] = (data_frame[self.trg_args.trg_col_op_price] - data_frame[
            self.trg_args.trg_col_ch_prev_clos]) / data_frame[self.trg_args.trg_col_ch_prev_clos] * 100
