...
class TestS3BucketConnectorMethods(unittest.TestCase):
    ...
    def setUp(self) -> None:
        ...
        os.environ[self.s3_access_key] = 'KEY 1'
        os.environ[self.s3_secret_key] = 'KEY 2'
    ...
    def test_list_files_in_prefix_ok(self):
        """
        Tests the list_file_in_prefix method for getting 2 file keys
    ...
    def test_list_files_in_prefix_wrong_prefix(self):
        """
        Test the list_files_in_prefix method in case of wrong or non existing prefix
        """
        # Expected results
    ...
    def test_read_csv_to_df_ok(self):
        """
        Tests the read_csv_to_df method for reading csv file from the mocked s3 bucket
        """
        #Expected results
        key_exp = 'test.csv'
        col1_exp = 'col1'
    ...
    def test_write_df_to_s3_empty(self):
        """
        Test the write_to_s3  method with an empty DataFrame as input
        """
        # Expected results
        return_exp = None
    ...
    def test_write_df_to_s3_csv(self):
        """
        Test the write_to_s3 method with a csv DF as input
        """
        # Expected results
        return_exp = True
    ...
    def test_write_df_to_s3_parquet(self):
        """
        Test the write_to_s3 method with a parquet DF as input
        """
        # Expected results
        return_exp = True
        df_exp = pd.DataFrame([['A', 'B'], ['C', 'D']], columns=['col1', 'col2'])
    ...
    def test_write_df_to_s3_wrong_format(self):
        """
        Test the write_to_s3 if a not supported format is given
        """
        # Expected results
        df_exp = pd.DataFrame([['A', 'B'], ['C', 'D']], columns=['col1', 'col2'])
        key_exp = 'test.parquet'
