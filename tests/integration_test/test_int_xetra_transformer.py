...
class IntTestXetraETLMethods(unittest.TestCase):
    ...
    def setUp(self):
        ...
        self.s3_bucket_name_src = 'xetra-src-roger-1234'
        self.s3_bucket_name_trg = 'xetra-trg-roger-1234'
        ...
        self.s3_bucket_src = S3BucketConnector(self.s3_endpoint_url,
                                               self.s3_bucket_name_src)
        self.s3_bucket_trg = S3BucketConnector(self.s3_endpoint_url,
